...
const SignUp = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-screen overflow-hidden">
      ...
      >
        <h3 className="text-2xl font-bold text-center text-white">Create Account ✨</h3>
        ...
        <form onSubmit={handleSignUp}>
          ...
          <p className="mt-4 text-sm text-gray-200 text-center">
            ...
            <Link className="font-semibold text-pink-300 hover:text-white underline" to="/login">
              Login
            </Link>
          </p>
        </form>
